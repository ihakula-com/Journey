...
- (void)requestFinished:(ASIFormDataRequest*)request
{
    ...
    if (request.responseStatusCode == 401 || request.responseStatusCode == 500) {
        ...
        if (401 == request.responseStatusCode) {
            [responseDic setObject:@"Fel användarnamn eller lösenord." forKey:@"message"];
        } else {
            [responseDic setObject:@"Hoppsan! Ett fel inträffade, var vänlig försök igen senare." forKey:@"message"];
        }
    } else {
